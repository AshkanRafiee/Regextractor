...
public class EdgeCaseTest {
    ...
    public void namedBaseReflectsContentAcrossPreciseAndBroad() {
        ...
        assertEquals("(?<number1>[0-9]{1,})", build("31415", options(true, true, false, false, false)));
        assertEquals("(?<value1>[0-9.]{1,})", build("3.14", options(true, true, false, false, false)));
        assertEquals("(?<word1>[a-z]{1,})", build("hello", options(true, true, false, false, false)));
    }
